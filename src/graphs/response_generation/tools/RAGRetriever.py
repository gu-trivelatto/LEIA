...
#         client = qdrant_client.QdrantClient(api_key=settings.qdrant.API_KEY.get_secret_value(), url=settings.qdrant.URL)
#         embedding_model = HuggingFaceEmbedding(model_name=settings.huggingface.EMBEDDING_MODEL)
